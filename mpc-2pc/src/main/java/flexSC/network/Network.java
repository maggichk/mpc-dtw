...
public class Network {
	...
	public byte[] readBytes(int len) {
		...
		try {
			...
			while (0 < remain) {
				...
				//System.out.println("readBytes:"+readBytes+" len:"+len+" remain:"+remain);
				if(readBytes == -1) {
	...
	public void writeShort(short i) { writeByte(ByteBuffer.allocate(8).putShort(i).array(), 8);
	}
	...
	public short readShort() {
		return ByteBuffer.wrap(readBytes(8)).getShort();
	}
