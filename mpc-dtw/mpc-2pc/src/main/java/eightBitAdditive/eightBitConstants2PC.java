...
public class eightBitConstants2PC {
	//modulus
	public static final short MODULUS = (short) 256;//32768; //2^31:2147483648 0```31~1```31
	//max value+1 of positive integer = 2^31 (31 bits range)
	//public static final long MAX_PLUS_1 = 2147483648L;
	
	
	public static final short MODULUS_32 = Short.valueOf((short) (2^8));
	public static final short MAX_DBL = Short.valueOf((short) (2^8-1));
