...
public class fifteenBitMulP0 {
	...
	public void compute(boolean isDisconnect, Server sndChannel, fifteenBitMultiplicationTriple mt,	short x0, short y0) {
		this.x0 = x0;
		this.y0 = y0;
	...
	public short[] ef0(fifteenBitMultiplicationTriple mt, short x0, short y0) {
		short tripleA0 = mt.tripleA0;
		short tripleB0 = mt.tripleB0;
		// long tripleC0 = mt.tripleC0;
		short e0 = fifteenBitAdditiveUtil.sub(x0, tripleA0);// e0= x0 - a0
		short f0 = fifteenBitAdditiveUtil.sub(y0, tripleB0);// f0 = y0 - b0
		short[] res = new short[2];
		res[0] = e0;
		res[1] = f0;
		return res;
	...
	public void mulP0(fifteenBitMultiplicationTriple mt, short e0, short f0, short e1, short f1) {
		/*
		...
		this.z0 = fifteenBitAdditiveUtil.add(fifteenBitAdditiveUtil.add(fifteenBitAdditiveUtil.mul(f, mt.tripleA0), fifteenBitAdditiveUtil.mul(e, mt.tripleB0)),
				mt.tripleC0);
